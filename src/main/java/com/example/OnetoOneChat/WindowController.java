...
public class WindowController {
    ...
    void handleSendMessage(ActionEvent event) {
        ...
        if (!userInput.isEmpty()) {
            chatService.sendMessageToChat(activeChatId, loggedInUser, userInput);
            textfield.clear();
        }
    }
    ...
    public void configureChatWindow(String chatId, String username) {
        this.activeChatId = chatId;
        this.loggedInUser = username;
        this.chatService = new FirestoreService();

        chatService.streamMessagesLive(chatId, vbox, username);
    }
}
